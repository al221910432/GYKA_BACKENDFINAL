...
import com.example.oxxo.model.request.LoginRequest;
import com.example.oxxo.model.response.MessageResponse;
import com.example.oxxo.model.response.UserInfoResponse;
import com.example.oxxo.security.jwt.JwtUtils;
import com.example.oxxo.security.service.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> logoutUser() {
      ...
      return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, cookie.toString())
          .body(new MessageResponse("¡Se ha cerrado sesión!"));
    }
}
